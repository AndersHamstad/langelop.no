export default function Footer() {
  ...
  <a href="mailto:hei@langelop.no" className="text-blue-400 hover:underline">
    post@langelop.no 
  </a> 
  {" "}eller 95 00 74 34.
</p>
          ...
          <div>
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex flex-col sm:flex-row sm:items-center gap-2">
              <input
                type="email"
